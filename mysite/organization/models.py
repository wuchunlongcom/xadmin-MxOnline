...
class Teacher(models.Model):
    ...
    certificate_no = models.IntegerField('教师资格证编号',default=200602140020095)
    work_years = models.IntegerField('教龄',default=10)
    work_company = models.CharField('就职公司',max_length=50, default='新东方学校')
    work_position = models.CharField('公司职位',max_length=50, default='高级教师')
