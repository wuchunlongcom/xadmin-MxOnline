    ...
    widgets = [
        [
            ...
            {"type": "chart", "model": "app.accessrecord", "chart": "user_count",
             "params": {"_p_date__gte": "2019-11-08", "p": 1, "_p_date__lt": "2019-11-29"}},
            # 显示模型内容
...
class GlobalSetting(object):
    ...
    site_title = '我们的网站标题'
    # 网站的下角标文字
    site_footer = '20200106 by xadmin'
    # 全局搜索
...
#xadmin.sites.site.register(Host)
...
class SchoolResource(resources.ModelResource):
    ...
    def __init__(self):
        ...
        """        
        super(SchoolResource, self).__init__()                
        field_list = apps.get_model('app', 'School')._meta.fields # 应用名与模型名
...
class SchoolAdmin(object):
    ...
    # 配置自定义按钮
    add_form_button = True  
    
    # 配置模型图标
    model_icon = 'fa fa-wifi' # 'fa fa-laptop' #fa fa-wifi
...
>>>>>>> 38e102888fd393e66e2198ca2ec4afda063c3215
