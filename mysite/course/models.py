...
class Course(models.Model):
    ...
    desc = models.CharField("课程描述",max_length=300, null=True, blank=True)
    #detail = models.TextField("课程详情", default='')
    detail = UEditorField(verbose_name=u'课程详情', width=600, height=300, imagePath="courses/ueditor/",
                          filePath="courses/ueditor/", default='')


    degree = models.CharField('难度',choices=DEGREE_CHOICES, max_length=2, null=True, blank=True)
    learn_times = models.IntegerField("学习时长(分钟数)",default=20)
    students = models.IntegerField("学习人数",default=10)
    ...
    teacher_tell = models.CharField('老师告诉你',max_length=300, null=True, blank=True)
...
class Lesson(models.Model):
    ...
    name = models.CharField("章节名",max_length=100, default='章节名')
    add_time = models.DateTimeField("添加时间",default=datetime.now)
    ...
    def __str__(self):
        return '《%s》课程的章节 >> %s' %(self.course, self.name)
...
class Video(models.Model):
    ...
    learn_times = models.IntegerField("学习时长(分钟数)", default=10)
    add_time = models.DateTimeField("添加时间", default=datetime.now)
...
class CourseResource(models.Model):
    ...
    download = models.FileField("资源文件",upload_to="course/resource/%Y/%m",max_length=100,null=True,blank=True)
    add_time = models.DateTimeField("添加时间", default=datetime.now)
